  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="px-6 py-4 border-b border-slate-200 bg-white flex items-center justify-between">
        ...
        {/* Public 'Need help?' link — reachable BEFORE login.
            Audit flagged that locked-out users had no support path. */}
        <Link
          href="/help"
      ...
      <footer className="px-6 py-4 text-center text-xs text-slate-400">
        ...
        <span> · </span>
        <Link href="/help" className="hover:text-slate-600">Help</Link>
      </footer>
    </div>
  );
}
